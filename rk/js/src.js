...
var g = svg.append("g"),
  tooltip = d3
    ...
    .style("opacity", 1),
  casesByState = {};
d3.json("https://raw.githubusercontent.com/khan-rehan/Roboslog_internship/master/map.json?token=AKCOFMPPRD4BARHCHYSU3TS65LHHG", function (error, data) {
...
var chartContainer1 = document.querySelector("#chartContainer1");
var chartContainer2 = document.querySelector("#chartContainer2");
var chartContainer3 = document.querySelector("#chartContainer3");
var chartContainer4 = document.querySelector("#chartContainer4");
var chartContainer5 = document.querySelector("#chartContainer5");
var chartContainer6 = document.querySelector("#chartContainer6");
var chartContainer7 = document.querySelector("#chartContainer7");

function myFunction(x) {
  if (x.matches) { // If media query matches
    chartContainer.style.height="200px";
chartContainer.style.width="100%";
chartContainer.style.paddingRight="0px";

chartContainer1.style.height="300px";
chartContainer1.style.width="100%";
chartContainer1.style.paddingRight="0px";

chartContainer2.style.height="300px";
chartContainer2.style.width="100%";
chartContainer2.style.paddingLeft="0px";

chartContainer3.style.height="200px";
chartContainer3.style.width="100%";
chartContainer3.style.paddingLeft="0px";

chartContainer4.style.height="400px";
chartContainer4.style.width="100%";
chartContainer4.style.paddingRight="0px";

chartContainer5.style.height="200px";
chartContainer5.style.width="100%";
chartContainer5.style.paddingRight="0px";

chartContainer6.style.height="200px";
chartContainer6.style.width="100%";
chartContainer6.style.paddingLeft="0px";

chartContainer7.style.height="900px";
chartContainer7.style.width="100%";
chartContainer7.style.paddingLeft="0px";
  } else {
  }
}
